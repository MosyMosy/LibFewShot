...
This file contains Conv32F_no_affine(ReLU/LeakyReLU), Conv64F_no_affine(ReLU/LeakyReLU) and R2D2Embedding_no_affine.
"""
...
class Conv64F_no_affine(nn.Module):
    """
    ...
    def __init__(
        ...
        super(Conv64F_no_affine, self).__init__()
...
class Conv32F_no_affine(nn.Module):
    """
    Four convolutional blocks network, each of which consists of a Covolutional layer,
    a Batch Normalizaiton layer, a ReLU layer and a Maxpooling layer.
    Used in the original ProtoNet: https://github.com/jakesnell/prototypical-networks.git.
    ...
    def __init__(
        ...
        super(Conv32F_no_affine, self).__init__()
...
class R2D2Embedding_no_affine(nn.Module):
    """
    ...
    def __init__(
        ...
        super(R2D2Embedding_no_affine, self).__init__()
