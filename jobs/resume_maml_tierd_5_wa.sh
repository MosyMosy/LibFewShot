...
#SBATCH --job-name=resume_maml_tierd_5_wa
...
cd ..
python run_trainer_resume.py --resume_path ./results/MAML-tiered_imagenet-Conv64F-5-5-freeitter-Nov-10-2021-20-12-49/

wait

cd $SLURM_TMPDIR
cp -r $SLURM_TMPDIR/LibFewShot/results/MAML-tiered_imagenet-Conv64F-5-5-freeitter-Nov-10-2021-20-12-49 ~/scratch/LibFewShot/results/