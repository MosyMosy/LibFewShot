...
#SBATCH --job-name=Proto_mini_no_affine_freeitter
...
for shot in 1 5; do
    python run_trainer.py --shot_num $shot --train_episode 10000 --training_test_episode 1000 --epoch 100 --test_epoch 5 --tag freeitter --conf_file ./config/proto_no_affine.yaml --data_root ./dataset/miniImageNet--ravi
