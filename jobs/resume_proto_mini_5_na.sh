...
#SBATCH --job-name=resume_proto_mini_na5
...
cd ..
python run_trainer_resume.py --resume_path './results/ProtoNet-miniImageNet--ravi-Conv64F_no_affine-5-5-freeitter-Nov-11-2021-01-54-59/'

wait

cd $SLURM_TMPDIR
cp -r $SLURM_TMPDIR/LibFewShot/results/ProtoNet-miniImageNet--ravi-Conv64F_no_affine-5-5-freeitter-Nov-11-2021-01-54-59 ~/scratch/LibFewShot/results/