...
#SBATCH --job-name=resume_proto_mini_na1
...
cd ..
python run_trainer_resume.py --resume_path './results/ProtoNet-miniImageNet--ravi-Conv64F_no_affine-5-1-freeitter-Nov-10-2021-17-30-01/'

wait

cd $SLURM_TMPDIR
cp -r $SLURM_TMPDIR/LibFewShot/results/ProtoNet-miniImageNet--ravi-Conv64F_no_affine-5-1-freeitter-Nov-10-2021-17-30-01 ~/scratch/LibFewShot/results/