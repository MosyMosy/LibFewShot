...
#SBATCH --job-name=resume_maml_mini_1_na
...
cd ..
python run_trainer_resume.py --resume_path ./results/MAML-miniImageNet--ravi-Conv64F_no_affine-5-1-freeitter-Nov-10-2021-16-35-06/

wait

cd $SLURM_TMPDIR
cp -r $SLURM_TMPDIR/LibFewShot/results/MAML-miniImageNet--ravi-Conv64F_no_affine-5-1-freeitter-Nov-10-2021-16-35-06 ~/scratch/LibFewShot/results/