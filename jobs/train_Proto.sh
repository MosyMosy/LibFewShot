...
# python run_trainer.py --shot_num 5 --data_root ./dataset/miniImageNet--ravi --conf_file ./config/Reproduce/ProtoNet-miniImageNet-Conv64F-5-5-Table2.yaml
# python run_trainer.py --shot_num 5 --data_root ./dataset/tiered_imagenet --conf_file ./config/Reproduce/ProtoNet-miniImageNet-Conv64F-5-5-Table2.yaml


cd $SLURM_TMPDIR
cp -r $SLURM_TMPDIR/LibFewShot/results/ProtoNet* ~/scratch/LibFewShot/results/