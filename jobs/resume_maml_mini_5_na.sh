...
#SBATCH --job-name=resume_maml_mini_5_na
...
cd ..
python run_trainer_resume.py --resume_path ./results/MAML-miniImageNet--ravi-Conv64F_no_affine-5-5-freeitter-Nov-10-2021-22-52-12/

wait

cd $SLURM_TMPDIR
cp -r $SLURM_TMPDIR/LibFewShot/results/MAML-miniImageNet--ravi-Conv64F_no_affine-5-5-freeitter-Nov-10-2021-22-52-12 ~/scratch/LibFewShot/results/