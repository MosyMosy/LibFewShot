...
#SBATCH --job-name=resume_maml_tierd_5_na
...
cd ..
python run_trainer_resume.py --resume_path ./results/MAML-tiered_imagenet-Conv64F_no_affine-5-5-freeitter-Nov-11-2021-00-42-01/

wait

cd $SLURM_TMPDIR
cp -r $SLURM_TMPDIR/LibFewShot/results/MAML-tiered_imagenet-Conv64F_no_affine-5-5-freeitter-Nov-11-2021-00-42-01 ~/scratch/LibFewShot/results/