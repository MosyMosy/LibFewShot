...
for shot in 1 5; do
    ...
    python run_trainer.py --shot_num $shot --train_episode 300 --epoch 100 --test_epoch 5 --conf_file ./config/proto.yaml --data_root ./dataset/miniImageNet--ravi
    mv $SLURM_TMPDIR/LibFewShot/temp/* ~/scratch/LibFewShot/results/

    python run_trainer.py --shot_num $shot --train_episode 3505 --epoch 100 --test_epoch 5 --conf_file ./config/proto.yaml --data_root ./dataset/tiered_imagenet
    mv $SLURM_TMPDIR/LibFewShot/temp/* ~/scratch/LibFewShot/results/
