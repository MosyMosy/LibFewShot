...
for shot in 1 5; do
    ...
    python run_trainer.py --shot_num $shot --train_episode 300 --test_episode 2000 --epoch 100 --test_epoch 5 --conf_file ./config/proto.yaml --data_root ./dataset/miniImageNet--ravi
    python run_trainer.py --shot_num $shot --train_episode 3505 --test_episode 2000 --epoch 100 --test_epoch 5 --conf_file ./config/proto.yaml --data_root ./dataset/tiered_imagenet
done
