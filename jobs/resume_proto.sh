...
cd $SLURM_TMPDIR
cp -r $SLURM_TMPDIR/LibFewShot/results/ProtoNet-miniImageNet--ravi-Conv64F-5-1-freeitter-Nov-10-2021-11-04-28 ~/scratch/LibFewShot/results/