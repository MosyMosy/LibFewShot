...
cd ..
python run_trainer_resume.py resume_path './results/MAML-miniImageNet--ravi-Conv64F-5-1-freeitter-Nov-10-2021-10-58-39/'

wait

cd $SLURM_TMPDIR
cp -r $SLURM_TMPDIR/LibFewShot/results/MAML-miniImageNet--ravi-Conv64F-5-1-freeitter-Nov-10-2021-10-58-39 ~/scratch/LibFewShot/results/