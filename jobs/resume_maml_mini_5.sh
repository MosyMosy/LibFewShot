...
#SBATCH --job-name=resume_maml_mini_5_wa
...
cd ..
python run_trainer_resume.py --resume_path ./results/MAML-miniImageNet--ravi-Conv64F-5-5-freeitter-Nov-10-2021-16-36-04/

wait

cd $SLURM_TMPDIR
cp -r $SLURM_TMPDIR/LibFewShot/results/MAML-miniImageNet--ravi-Conv64F-5-5-freeitter-Nov-10-2021-16-36-04 ~/scratch/LibFewShot/results/